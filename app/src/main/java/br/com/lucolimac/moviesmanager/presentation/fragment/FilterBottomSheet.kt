...
import br.com.lucolimac.moviesmanager.databinding.BottomSheetFilterMovieBinding
import br.com.lucolimac.moviesmanager.domain.entity.Sort
import com.google.android.material.bottomsheet.BottomSheetDialogFragment
import com.google.android.material.chip.Chip

class FilterBottomSheet(val onChangeSortSelection: (Sort) -> Unit) : BottomSheetDialogFragment() {
    private var _binding: BottomSheetFilterMovieBinding? = null
    private val binding
        get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = BottomSheetFilterMovieBinding.inflate(inflater, container, false)
        return binding.root
    }
